...
/**
 * {@link java.util.LinkedHashMap} variant that stores String keys in a case-insensitive manner, for example for key-based access
 * in a results table.
 *
 * <p>
...
public class LinkedCaseInsensitiveMap<V> extends LinkedHashMap<String, V> {
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link java.util.LinkedHashMap} with the given initial capacity and
