 ...
 * getters for all components. Effectively similar to {@link java.net.URI}, but with more powerful encoding options and support
...
public final class UriComponents {
     ...
     * @return the encoded uri components
     * @throws java.io.UnsupportedEncodingException if the given encoding is not supported
     */
