 ...
 *
 * <p>This error handler checks for the status code on the {@link org.springframework.http.client.ClientHttpResponse}: any code with series
 * {@link org.springframework.http.HttpStatus.Series#CLIENT_ERROR} or
 * {@link org.springframework.http.HttpStatus.Series#SERVER_ERROR} is considered to be an error.
 * This behavior can be changed by overriding the {@link #hasError(org.springframework.http.HttpStatus)} method.
 *
...
public class DefaultResponseErrorHandler implements ResponseErrorHandler {
	...
	/**
	 * Delegates to {@link #hasError(org.springframework.http.HttpStatus)} with the response status code.
	 */
	...
	/**
	 * Template method called from {@link #hasError(org.springframework.http.client.ClientHttpResponse)}.
