 ...
 * #getForObject(String, Class, java.util.Map)}), and are capable of substituting any {@linkplain UriTemplate URI templates} in
 ...
 * </pre>
 * will perform a GET on {@code http://example.com/hotels/42/rooms/42}. Alternatively, there are {@link java.net.URI} variant
 * methods ({@link #getForObject(java.net.URI, Class)}), which do not allow for URI templates, but allow you to reuse a single,
