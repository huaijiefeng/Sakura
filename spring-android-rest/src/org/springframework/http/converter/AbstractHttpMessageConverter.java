 ...
 * {@link #setSupportedMediaTypes(java.util.List) supportedMediaTypes} bean property. It also adds
...
public abstract class AbstractHttpMessageConverter<T> implements HttpMessageConverter<T> {
	...
	/**
	 * Returns true if any of the {@linkplain #setSupportedMediaTypes(java.util.List) supported media types}
	 ...
	 * {@linkplain #setSupportedMediaTypes(java.util.List) supported media types}.
	...
	/**
	 * This implementation simple delegates to {@link #readInternal(Class, org.springframework.http.HttpInputMessage)}.
	 ...
	 * {@link #setSupportedMediaTypes(java.util.List) supportedMediaTypes} property, if any.
