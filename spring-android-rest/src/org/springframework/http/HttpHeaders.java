 ...
 *
 * <p>In addition to the normal methods defined by {@link java.util.Map}, this class offers the following convenience methods:
 * <ul>
...
public class HttpHeaders implements MultiValueMap<String, String> {
	...
	/**
	 * Return the list of acceptable {@linkplain java.nio.charset.Charset charsets}, as specified by the {@code Accept-Charset}
	 * header.
	 ...
	 * @see #setAcceptEncoding(java.util.List)
	 ...
	 * @see #setContentEncoding(java.util.List)
