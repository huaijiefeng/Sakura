...
public abstract class AbstractClientHttpRequestFactoryWrapper implements ClientHttpRequestFactory {
	...
	/**
	 * This implementation simply calls {@link #createRequest(java.net.URI, HttpMethod, ClientHttpRequestFactory)} with the
	 ...
	 * factory.
	 * <p>
	 * Called from {@link #createRequest(java.net.URI, HttpMethod)}.
